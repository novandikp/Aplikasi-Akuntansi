...
Public Class PreviewPelanggan
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanPelangganAktif.rdlc"
        ...
        'Sql = "SELECT * from view_pelanggan  where pelanggan like '%" & eCari.Text & "%' or alamatpelanggan like '%" & eCari.Text & "%'"
