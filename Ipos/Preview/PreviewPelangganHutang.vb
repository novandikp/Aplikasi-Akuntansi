...
Public Class PreviewPelangganHutang
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanHutangUpdate.rdlc"
        ...
        'Dim sql As String = "SELECT * from view_pelanggan  where hutang > 0 and (pelanggan like '%" & eCari.Text & "%' or alamatpelanggan like '%" & eCari.Text & "%')"
