...
Public Class PreviewStokOpname
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanStokOpname.rdlc"
        ...
        'Dim sql As String = "SELECT produk, tglstok, awal, jumlah, akhir, keterangan from view_stokopname  where tglstok between ('" & awal & " 00:00:00') and ('" & akhir & " 23:59:59')  and (idproduk like '%" & eCari.Text & "%' or produk like '%" & eCari.Text & "%')"
