...
Public Class PreviewStok
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanStok.rdlc"
        ...
        ' Dim sql As String = "SELECT * from view_stok  where tglstok between ('" & awal & " 00:00:00') and ('" & akhir & " 23:59:59')  and (idproduk like '%" & eCari.Text & "%' or produk like '%" & eCari.Text & "%')"
