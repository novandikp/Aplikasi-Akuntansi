...
Public Class PreviewPenjualanDokter
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanPenjualanDokter.rdlc"
        ...
        'Dim sql As String = "SELECT * from view_detailjual  where tgljual between ('" & awal & " 00:00:00') and ('" & akhir & " 23:59:59')  and (pelanggan like '%" & eCari.Text & "%' or fakturjual like '%" & eCari.Text & "%')"
        ...
        ReportViewer1.LocalReport.SetParameters(New ReportParameter("group", "adasdas"))
