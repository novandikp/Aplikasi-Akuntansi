...
Public Class PreviewHutang
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanHutang.rdlc"
        ...
        ' Dim sql As String = "SELECT pelanggan, tglhutang, bayarhutang from view_hutang  where tglhutang between ('" & awal & " 00:00:00') and ('" & akhir & " 23:59:59')  and (pelanggan like '%" & eCari.Text & "%' or alamatpelanggan like '%" & eCari.Text & "%')"
