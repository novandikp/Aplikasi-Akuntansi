...
Public Class PreviewSupplier
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        If tipe = 0 Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanSupplier.rdlc"
        Else
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanTeknisi.rdlc"
        ...
        'Dim sql As String = "SELECT * from tblsupplier  where supplier like '%" & eCari.Text & "%' or alamatsupplier like '%" & eCari.Text & "%'"
