...
Public Class PreviewPenjualan
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        If servis Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanServis.rdlc"
        Else
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanPenjualanPelanggan.rdlc"
        End If
