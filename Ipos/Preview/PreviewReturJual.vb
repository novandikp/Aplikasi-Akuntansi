...
Public Class PreviewReturJual
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanReturJual.rdlc"
        ...
        'Dim sql As String = "SELECT * from view_returjual  where tglreturjual between ('" & awal & " 00:00:00') and ('" & akhir & " 23:59:59') and (idproduk like '%" & eCari.Text & "%' or produk like '%" & eCari.Text & "%')"
