...
Public Class PreviewPiutang
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanPiutang.rdlc"
        ...
        'Dim sql As String = "SELECT * from view_piutang  where tglpiutang between ('" & awal & " 00:00:00') and ('" & akhir & " 23:59:59')  and (supplier like '%" & eCari.Text & "%' or alamatsupplier like '%" & eCari.Text & "%')"
