Public Class LaporanLaba
    ...
    Private Sub DtAkhir_KeyDown(sender As Object, e As KeyEventArgs) _
        ...
        ElseIf e.KeyCode = Keys.F1 Then
            If open Then
                open = False
                Dim preview As PreviewLaba = New PreviewLaba()
                preview.sql = sql
    ...
    Sub laporanBarangLengkap()
        ...
        sql =
            "SELECT fakturjual, produk, tgljual, jumlahjual,satuanjual, laba as hargajual, laba * jumlahjual as sub  from view_detailjual  where tgljual between ('" &
        ...
        Try
            ...
            DataGridView1.Columns(5).HeaderText = "Laba"
