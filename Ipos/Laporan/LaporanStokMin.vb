Public Class LaporanStokMin
    ...
    Sub laporanBarangTanpaHarga()
        ...
        End If
        sql =
            "Select idproduk, produk, kategori,  (stok1 + stok2 * konversi1 + stok3 * konversi1 * konversi2) As stokis, stokmin from view_produk As T1 where (produk Like '%" &
        ...
        Try
            ...
            DataGridView1.Columns(4).HeaderText = "Stok Minimal"
