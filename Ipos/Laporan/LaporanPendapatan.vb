Public Class LaporanPendapatan
    ...
    Sub laporanBarangLengkap()
        ...
        sql =
            "SELECT granddiskon, fakturjual, tgljual,  pelanggan, total, bayar, kembali from view_jual  where tgljual between ('" &
            awal & " 00:00:00') and ('" & akhir & " 23:59:59') and flag=1 and (pelanggan like '%" & eCari.Text &
        ...
        Try
            DataGridView1.Columns(1).HeaderText = "Faktur"
            DataGridView1.Columns(2).HeaderText = "Tanggal"
            DataGridView1.Columns(3).HeaderText = "Pelanggan"
            DataGridView1.Columns(4).HeaderText = "Total"
            DataGridView1.Columns(5).HeaderText = "Bayar"
            DataGridView1.Columns(6).HeaderText = "Kembali"
