Public Class LaporanReturJual
    ...
    Private Sub DtAkhir_KeyDown(sender As Object, e As KeyEventArgs) _
        ...
        ElseIf e.KeyCode = Keys.F1 Then
            If open Then
                open = False
                Dim preview As PreviewReturJual = New PreviewReturJual()
                preview.sql = sql
    ...
    Sub laporanBarangLengkap()
        ...
        sql =
            "SELECT fakturjual,tglreturjual, produk, jumlahreturjual, jumlahjual, satuanjual from view_returjual  where tglreturjual between ('" &
        ...
        Try
            ...
            DataGridView1.Columns(3).HeaderText = "Jumlah Retur"
            DataGridView1.Columns(4).HeaderText = "Jumlah Jual"
