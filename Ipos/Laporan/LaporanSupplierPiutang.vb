Public Class LaporanSupplierPiutang
    ...
    Sub laporanBarangLengkap()
        ...
        sql =
            "SELECT  supplier,  jatuhtempo as tglpiutang, jumlahbayar as bayarpiutang, sisasaldp as nosupplier, keterangan as alamatsupplier, idsupplier, fakturbeli as idpiutang from view_piutang_temp where  jatuhtempo between ('" &
            awal & "') and ('" & akhir & "')  and (supplier like '%" & eCari.Text & "%' or alamatsupplier like '%" &
            eCari.Text & "%')"
