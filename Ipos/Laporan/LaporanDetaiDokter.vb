Public Class LaporanDetailDokter
    ...
    Sub laporanBarangLengkap()
        ...
        sql =
            "SELECT fakturjual, tgljual, dokter as pelanggan, produk, jumlahjual, hargajual, hargajual-laba as kartu, resep as idproduk, iddokter as idpelanggan from view_detailjual  where tgljual between ('" &
            awal & " 00:00:00') and ('" & akhir & " 23:59:59') and flag=1 and (produk like '%" & eCari.Text &
            "%' or dokter like '%" & eCari.Text & "%') and iddokter > 1 and idkategori = 1"
        ...
        Try
            DataGridView1.Columns(0).HeaderText = "Faktur"
            DataGridView1.Columns(1).HeaderText = "Tanggal"
            DataGridView1.Columns(2).HeaderText = "Teknisi"
            ...
            DataGridView1.Columns(6).HeaderText = "Bagi Hasil"
            DataGridView1.Columns(7).HeaderText = "Plat"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If open Then
            open = False
            Dim preview As PreviewPenjualanDokter = New PreviewPenjualanDokter()
            preview.sql = sql
            preview.laporanBarangLengkap()
            preview.ShowDialog()
            preview.Dispose()
