Public Class LaporanReturBeli
    ...
    Sub laporanBarangLengkap()
        ...
        sql =
            "SELECT fakturbeli,tglreturbeli, produk, jumlahreturbeli, jumlahbeli, satuanbeli from view_returbeli  where tglreturbeli between ('" &
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If open Then
            open = False
            Dim preview As PreviewReturBeli = New PreviewReturBeli()
            preview.sql = sql
