Public Class LaporanHutang
    ...
    Private Sub DtAkhir_KeyDown(sender As Object, e As KeyEventArgs) _
        ...
        ElseIf e.KeyCode = Keys.F1 Then
            If open Then
                open = False
                Dim preview As PreviewHutang = New PreviewHutang()
                preview.sql = sql
    ...
    Sub laporanBarangLengkap()
        ...
        sql =
            "SELECT pelanggan, tglhutang as tglhutang, bayarhutang, jumlahbayar + sisasaldp as hutang, saldo as nopelanggan,  kethutang as alamatpelanggan, fakturjual as idhutang from view_hutang  where tglhutang between ('" &
            awal & " 00:00:00') and ('" & akhir & " 23:59:59')  and (pelanggan like '%" & eCari.Text &
            "%' or alamatpelanggan like '%" & eCari.Text & "%')"
        ...
        Try
            ...
            DataGridView1.Columns(3).HeaderText = "Jumlah Hutang"
            DataGridView1.Columns(4).HeaderText = "Salo Hutang"
