Public Class CariDokter
    ...
    Sub getDataPelanggan()
        ...
        Me.listSupplier.DataSource =
            getData(
                "SELECT iddokter, dokter, alamatdokter, nodokter from tbldokter where (dokter LIKE '%" & eCari.Text &
        ...
        Try
            ...
            listSupplier.Columns(1).HeaderText = "Nama Teknisi"
    ...
    Private Sub ListItem_KeyDown(sender As Object, e As KeyEventArgs) _
        ...
        ElseIf e.KeyCode = Keys.Enter Then
            ...
            If listSupplier.SelectedRows.Count = 1 Then
                Me.Close()
                Form1.setDokterJual(listSupplier.Rows(listSupplier.CurrentCell.RowIndex).Cells(0).Value.ToString)
            End If
    ...
    Sub tambahPelangga()
        TambahDokter.ShowDialog()
        TambahDokter.Dispose()
    End Sub
    ...
    Private Sub listSupplier_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) _
        ...
        Me.Close()
        Form1.setDokterJual(listSupplier.Rows(e.RowIndex).Cells(0).Value.ToString)
    End Sub
