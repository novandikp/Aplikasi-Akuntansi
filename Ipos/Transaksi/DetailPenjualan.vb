...
Public Class DetailPenjualan
    ...
    Sub getDataProduk()
        ...
        Me.ListSat.DataSource =
            getData(
                "SELECT barcode, produk, tgljual, jumlahjual, satuanjual, hargajual from view_detailjual where idjual=" &
        ...
        Try
            ...
            ListSat.Columns(4).HeaderText = "Satuan Jual"
            ListSat.Columns(5).HeaderText = "Harga Jual"
