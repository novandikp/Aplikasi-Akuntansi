...
Public Class FormPengirimanJual
...
GROUP by  tblharga.idbarang,T.nilaidasar, B.nilaidasar,T.idharga,B.idharga ,Y.idharga "
    ...
    Sub isidetail(refrensi As String)
        ...
        Dim dataDebit As String() = {akunPersediaanBelumDitagihkan, kodeprojek, ComboBox1.SelectedValue, CBsupplier.SelectedValue, dtTanggal.Value.ToString("yyyy-MM-dd HH:mm:ss").Replace(".", ":"), Totalhpp.ToString.Replace(",", "."), "0", "PD", TBnotransaksi.Text, "Pengiriman Penjualan, " & CBsupplier.Text}
        Dim dataKredit As String() = {akunPersediaan, kodeprojek, ComboBox1.SelectedValue, CBsupplier.SelectedValue, dtTanggal.Value.ToString("yyyy-MM-dd HH:mm:ss").Replace(".", ":"), "0", Totalhpp.ToString.Replace(",", "."), "PD", TBnotransaksi.Text, "Pengiriman Penjualan, " & CBsupplier.Text}
    ...
    Sub tampilkanDialogPembayaran()
        ...
        If edited Then
            dialog.tableRefrensi = "tblpengirimanjual"
            dialog.keyRefrensi = "kodepengirimanjual"
