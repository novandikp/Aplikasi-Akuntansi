...
Public Class PreviewLaporanKontak
    Public sql As String = ""
    Public dataview As DataView
    Public saldoawal As Double = 0
    Public judul As String = "Pelanggan"
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.LaporanKontak.rdlc"
        ...
        ReportViewer1.LocalReport.SetParameters(New ReportParameter("Judul",
                                                                    judul.ToUpper))
