...
Public Class PreviewBukuBesarSederhana
    Public sql As String = ""
    Public dataview As DataTable
    Public saldoawal As Double = 0



    Public lengkap As Boolean = False
    ...
    Sub laporanBarangLengkap()
        ...
        If Not lengkap Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.BukuBesarSederhana.rdlc"
        Else
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.BukuBesarLengkap.rdlc"
        End If
        ...
        ReportViewer1.LocalReport.DataSources.Add(New ReportDataSource("DataSet1", CType(dataview, DataTable)))
