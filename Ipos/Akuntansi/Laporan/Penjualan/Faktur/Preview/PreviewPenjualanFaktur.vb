...
Public Class Previewjual
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        If detail Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.DetailPenjualanFaktur.rdlc"
        ElseIf Not ringkasan Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.PenjualanFakturRangkuman.rdlc"
        Else
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.PenjualanFakturRingkas.rdlc"
        End If
