...
Public Class PreviewReturJual
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        If detail Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.DetailReturJual.rdlc"
        ElseIf Not ringkasan Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.ReturJualRangkuman.rdlc"
        Else
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.ReturJualRingkas.rdlc"
        End If
