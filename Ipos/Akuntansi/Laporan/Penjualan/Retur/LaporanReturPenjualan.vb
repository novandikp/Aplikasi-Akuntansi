    ...
    Sub getDataLaporan()
        ...
        If ringkasan Then
            ...
            If cbSub.SelectedIndex > 0 Then
                sql = "SELECT tglreturjual, kodereturjual, COALESCE(kodejual,'-') as kodejual, tblkontak.pelanggan as idkontak,total, totalpajak
FROM tblreturjual
...
on tblkontak.idpelanggan = tblreturjual.pelanggan
        ...
        Else
            If cbSub.SelectedIndex > 0 Then
                sql = "SELECT tglreturjual, kodereturjual, COALESCE(kodejual,'-') as kodejual, tbldepartemen.departemen as kodedepartemen, COALESCE(kodeprojek,'N\A') as kodeprojek,total, diskonrupiah, diskonpersen, totalpajak, biayalain, bayar,kembali
FROM tblreturjual
