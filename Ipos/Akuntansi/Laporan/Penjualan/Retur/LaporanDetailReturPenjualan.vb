Public Class LaporanDetailReturPenjualan
    ...
    Sub getDataLaporan()
        ...
        If cbSub.SelectedIndex > 0 Then
            sql = "SELECT tblreturjual.tglreturjual, tblreturjual.kodereturjual, tblkontak.pelanggan, tbldepartemen.departemen, COALESCE(tblprojek.projek,'N/A') as projek, tblgudang.gudang, tbldetailreturjual.idbarang, tblproduk.produk, tbldetailreturjual.jumlahjual, tbldetailreturjual.hargajual from tbldetailreturjual inner join tblreturjual on tblreturjual.kodereturjual = tbldetailreturjual.kodereturjual inner join  tblkontak on tblkontak.idpelanggan = tblreturjual.pelanggan inner join tbldepartemen on tbldepartemen.iddepartemen = tblreturjual.kodedepartemen inner join tblgudang on tblgudang.idgudang = tblreturjual.kodegudang inner join tblproduk on tblproduk.idproduk = tbldetailreturjual.idbarang left join tblprojek on tblprojek.idprojek  = tblreturjual.kodeprojek
WHERE (tblreturjual.kodereturjual ILIKE '%" & eCari.Text & "%' or departemen ILIKE '%" & eCari.Text & "%'  )
          and kodedepartemen ='" & cbSub.SelectedValue & "' and tglreturjual BETWEEN '" & dtAwal.Value.ToString("yyyy/MM/dd") & "' and 
        '" & dtAkhir.Value.ToString("yyyy/MM/dd") & "'"
        Else
            sql = "SELECT tblreturjual.tglreturjual, tblreturjual.kodereturjual, tblkontak.pelanggan, tbldepartemen.departemen, COALESCE(tblprojek.projek,'N/A') as projek, tblgudang.gudang, tbldetailreturjual.idbarang, tblproduk.produk, tbldetailreturjual.jumlahjual, tbldetailreturjual.hargajual from tbldetailreturjual inner join tblreturjual on tblreturjual.kodereturjual = tbldetailreturjual.kodereturjual inner join  tblkontak on tblkontak.idpelanggan = tblreturjual.pelanggan inner join tbldepartemen on tbldepartemen.iddepartemen = tblreturjual.kodedepartemen inner join tblgudang on tblgudang.idgudang = tblreturjual.kodegudang inner join tblproduk on tblproduk.idproduk = tbldetailreturjual.idbarang left join tblprojek on tblprojek.idprojek  = tblreturjual.kodeprojek
WHERE (tblreturjual.kodereturjual ILIKE '%" & eCari.Text & "%' or departemen ILIKE '%" & eCari.Text & "%'  )
           and tglreturjual BETWEEN '" & dtAwal.Value.ToString("yyyy/MM/dd") & "' and 
        '" & dtAkhir.Value.ToString("yyyy/MM/dd") & "'"
        End If
