...
Public Class PreviewPengiriman
    ...
    Sub laporanBarangLengkap()
        ...
        If Not ringkasan Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.PengirimanRangkuman.rdlc"
        Else
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.PengirimanRingkas.rdlc"
        End If
