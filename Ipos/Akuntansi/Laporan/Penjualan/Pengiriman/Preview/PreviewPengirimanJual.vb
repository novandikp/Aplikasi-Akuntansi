...
Public Class PreviewPengirimanjual
    ...
    Sub laporanBarangLengkap()
        ReportViewer1.Reset()
        If detail Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.DetailPengirimanJual.rdlc"
        ElseIf Not ringkasan Then
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.PengirimanJualRangkuman.rdlc"
        Else
            ReportViewer1.LocalReport.ReportEmbeddedResource = "Ipos.PengirimanJualRingkas.rdlc"
        End If
