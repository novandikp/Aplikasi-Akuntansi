Public Class DialogPenawaranBeli
    Public kodepenawaranbeli As String
    ...
    Sub fillData()
        ...
        Dim sql As String = "SELECT tglpenawaranbeli,kodepenawaranbeli, tblkontak.pelanggan, total,diskonrupiah,biayalain,totalpajak,cast(statuspenawaran as varchar) from tblpenawaranbeli inner join tblkontak on tblkontak.idpelanggan = tblpenawaranbeli.pelanggan "
    ...
    Private Sub ListSat_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles ListSat.CellClick
        If e.RowIndex >= 0 Then
            kodepenawaranbeli = ListSat.Rows(e.RowIndex).Cells(1).Value
