Public Class DialogPenawaranJual
    Public kodepenawaranjual As String
    ...
    Sub fillData()
        ...
        Dim sql As String = "SELECT tglpenawaranjual,kodepenawaranjual, tblkontak.pelanggan, total,diskonrupiah,biayalain,totalpajak,cast(statuspenawaran as varchar) from tblpenawaranjual inner join tblkontak on tblkontak.idpelanggan = tblpenawaranjual.pelanggan "
    ...
    Private Sub ListSat_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles ListSat.CellClick
        If e.RowIndex >= 0 Then
            kodepenawaranjual = ListSat.Rows(e.RowIndex).Cells(1).Value
